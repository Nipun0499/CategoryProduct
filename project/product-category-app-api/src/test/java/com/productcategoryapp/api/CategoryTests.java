...
class CategoryTests {
    ...
    void getCategoryTest() {
        ...
        Category p2 = new Category(1, null,"Hello","This category is of Laptop", new Date(), new Date(), true, false);
    ...
    void getCategoryByIdTest() {
        Category p = new Category(1, null,"Laptop","This category is of Laptop", new Date(), new Date(), true, false);
    ...
    void updateCategoryTest() {
        CategoryDto p = new CategoryDto(1, null,"Laptop","This category is of Laptop", new Date(2022,8,1), new Date(), true, false);
    ...
    void getCategoryTest1() {
    	...
    	Product p11=new Product(1, null,"Laptop","HP", "This category is of Laptop",100000, new Date(2022,9,1), new Date(2022,9,10), true, false);
    	Product p12=new Product(1, null,"Desktop","HP", "This category is of Laptop",100000, new Date(), new Date(), true, false);
    	list1.add(p11);
    	list1.add(p12);
        Category p1 = new Category(1, list1,"Laptop","This category is of Laptop", new Date(), new Date(), true, false);
        Category p2 = new Category(1, null,"Hello","This category is of Laptop", new Date(), new Date(), true, false);
        List<Category> list = new ArrayList<Category>();
        list.add(p1);
        list.add(p2);
    ...
    void getCategoryByIdTest1() {
    	...
    	list.add(p11);
    	list.add(p12);
        Category p = new Category(1, list,"Laptop","This category is of Laptop", new Date(2022,7,12), new Date(), true, false);
        CategoryDto p1 = modelMapper.map(p, CategoryDto.class);
        Mockito.when(repo1.findById(1)).thenReturn(Optional.of(p));
        assertThat(service1.getCategory(1)).isEqualTo(p1);
    }
    ...
    void updateCategoryTest1() {
    	...
    	ProductDto p11=new ProductDto(1, null,"Laptop","HP", "This category is of Laptop",100000, new Date(2022,9,1), new Date(2022,9,10), true, false);
    	ProductDto p12=new ProductDto(1, null,"Desktop","HP", "This category is of Laptop",100000, new Date(), new Date(), true, false);
    	list.add(p11);
    	list.add(p12);
        CategoryDto p = new CategoryDto(1, list,"Laptop","This category is of Laptop", new Date(2022,8,1), new Date(), true, false);
        Category p2=modelMapper.map(p, Category.class);
        Mockito.when(repo1.save(p2)).thenReturn(p2);
        assertThat(service1.updateCategory(p)).isEqualTo(p);
    }
    ...
    void addCategoryTest1() {
    	...
    	list.add(p11);
    	list.add(p12);
        CategoryDto p = new CategoryDto(1, list,"Laptop","This category is of Laptop", new Date(2022,5,6), new Date(), true, false);
        Category p2=modelMapper.map(p,Category.class);
        Mockito.when(repo1.save(p2)).thenReturn(p2);
        assertThat(service1.addCategory(p)).isEqualTo(p);
    }
    ...
    void deleteCategoryTest1() {
    	List<Product>list=new ArrayList<>();
    	Product p11=new Product(1, null,"Laptop","HP", "This category is of Laptop",100000, new Date(2022,9,1), new Date(2022,9,10), true, false);
    	Product p2=new Product(1, null,"Desktop","HP", "This category is of Laptop",100000, new Date(), new Date(), true, false);
    	list.add(p11);
    	list.add(p2);
    	Category p = new Category(1,list,"Laptop","This category is of Laptop", new Date(2022,5,6), new Date(), true, false);
        Mockito.when(repo1.findById(1)).thenReturn(Optional.of(p));
        CategoryDto p1=modelMapper.map(p,CategoryDto.class);
        p1.setActive(false);
        p1.setDeleted(true);
